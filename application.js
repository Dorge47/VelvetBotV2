...
//Sends a generic request with the function of func, the data of data and will call callback when the request is fulfilled.
...
function sendPhoto(id, fileId, replyId) {
    ...
    var request = sendRequest("sendPhoto", message, function() {
        console.log(request.responseText);
    });
}

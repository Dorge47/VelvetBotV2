...
//Sends (text) to (id) as a reply to (replyId) with previews shown or disabled according to (disableShowPreview) in case of a link
exports.sendMarkdown = function(id, text, replyId, disableShowPreview) {
    var message = {
        chat_id: id,
        text: text,
        parse_mode: "Markdown",
